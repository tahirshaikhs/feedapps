        ...
        fetch("http://localhost:3000/viewmypost", {
            ...
            .then((response) => {
                if (response.ok) {
                    ...
                    const updatedPostsArray = posts.map(p => p.id === post.id ? updatedPost : p);
                    setPosts(updatedPostsArray);
                    setUpdatedPosts([...updatedPosts, updatedPost]);
                            ...
                            <tr key={post.id}>
                                ...
                                <td>
                                    <div className="tabled">
                                        <button onClick={() => handleApprove(post)} className="btn btn-success">Approved</button>
